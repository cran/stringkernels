...
#define SORTED_BY_ENHANCED_INDUCTION 0x3fffffff	// marks suffix which will be sorted by enhanced induction sort.
	...
	#define SYMBOL_CARDINAL  8192
#else
	#define SYMBOL_TYPE	     unsigned char
	#define SYMBOL_CARDINAL  256
#endif
...
private:
	...
	SYMBOL_TYPE		m_forwardAltSortOrder[SYMBOL_CARDINAL];

	static SYMBOL_TYPE		m_reverseAltSortOrder[SYMBOL_CARDINAL];
