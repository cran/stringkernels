...
// MSufSort.
//=============================================================================
SYMBOL_TYPE MSufSort::m_reverseAltSortOrder[SYMBOL_CARDINAL];


// chteo: Changed the member initialisation order to get rid of compilation warning [181006]
...
MSufSort::MSufSort():m_chainMatchLengthStack(8192, 0x10000, true),  m_chainCountStack(8192, 0x10000, true), 
                     m_chainHeadStack(8192, 0x20000, true), m_ISA(0), m_suffixesSortedByInduction(120000, 1000000, true)

{
	// constructor.
	/* MK change
     * This is completely arbitrary
     * Note: consider using MSufSort 3.1.1,
     *       with automated partitioning
     * now supports alphabets with up to 8192 symbols (again, this is arbitrary)
     * set by SYMBOL_CARDINAL 
     */
	unsigned int array[10] = {64,128,192,256,384,512,768,1024,2048,4096};
	int n = 0;
	for (; n < 10; n++)
	{
	...
	for (int i = 0; i < SYMBOL_CARDINAL; i++)
	{
